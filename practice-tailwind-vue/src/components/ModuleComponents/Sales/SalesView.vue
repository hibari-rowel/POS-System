...
<template>
    <Base>
        ...
        <template v-slot:main-content>
            <div class="flex flex-col h-full gap-3 pb-2">
                <div class="flex flex-col h-fit justify-center rounded-xl gap-2 py-2">
                    <div class="flex flex-row gap-2 overflow-x-auto py-1">
                        <button v-for="category in productCategoryStore.categories" :key="category.id" class="px-4 py-2 bg-white text-gray-700 rounded-lg shadow-sm hover:shadow-md cursor-pointer transition duration-300 ease-in-out text-nowrap">
                            {{ category.name }}
                        </button>
                    </div>
                </div>

                <div class="flex flex-row h-full w-full gap-4 overflow-hidden">
                    <!-- Product List -->
                    <div class="flex-1 bg-gray-100 overflow-y-auto mr-0 md:mr-8 hide-scrollbar">
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 xl:grid-cols-5 gap-4">
                        ...
                        <div class="flex flex-col flex-1 overflow-y-auto px-3 pt-2 space-y-3 hide-scrollbar">                            
                            ...
                            <div class="flex flex-col bg-white shadow-inner py-3 rounded-md">
                                <div class="border-b-2 border-gray-100 mb-2 px-2 pb-1 justify-center">
                                    <h2 class="text-base font-semibold text-nowrap">Pricing Summary</h2>
                                </div>
